...
class ComparatorTempodeEpisodio implements Comparator<Serie>{

    @Override
    public int compare(Serie t1, Serie t2) {
        return Integer.compare(t1.getTempoEpisodio(), t2.getTempoEpisodio());
    }
}